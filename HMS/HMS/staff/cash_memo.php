...
<body>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="patient_name" class="form-control" id="patient_name" onkeypress="return (event.charCode > 64 && 
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="mobile_no" id="mobile_no" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="city" class="form-control" id="city" onkeypress="return (event.charCode > 64 && 
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" >
                                        </div>
                                        <label for="loginid" class="control-label col-form-label">LoginID</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="loginid" id="loginid" onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group row">
