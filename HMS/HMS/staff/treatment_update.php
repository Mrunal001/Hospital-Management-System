                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="treatment_type" class="form-control"  value="<?php echo $row['treatment_type'];?>"  id="patient_name" >
                                            </div>
                                             <label for="blood_group" class="control-label col-form-label">Treatment Cost</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="treatment_cost" class="form-control"  value="<?php echo $row['treatment_cost'];?>"  id="blood_group">
                                            </div>
                                        </div>
                                    <div class="form-group row">
