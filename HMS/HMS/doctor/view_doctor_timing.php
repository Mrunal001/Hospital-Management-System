            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">View Timing</h5>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                             <?php
                                            $count=1;
                                            $sel_query="Select * from doctor_timing,doctor WHERE  doctor_time_dr_id = doctor_id AND doctor_time_dr_id = '".$_SESSION['doctor_id']."' ";
