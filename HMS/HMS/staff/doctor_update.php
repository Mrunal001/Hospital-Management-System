                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="doctor_name" class="form-control" id="doctor_name"  value="<?php echo $row['doctor_name'];?>"  >
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="doctor_loginid" class="form-control" id="doctor_loginid" value="<?php echo $row['doctor_loginid'];?>" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
