...
<body>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="doctor_name" class="form-control" id="doctor_name" onkeypress="return (event.charCode > 64 && 
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="doctor_loginid" class="form-control" id="doctor_loginid" onkeypress="return isNumberKey(event)" >
                                            </div>
                                        </div>
                                        <div class="form-group row">
