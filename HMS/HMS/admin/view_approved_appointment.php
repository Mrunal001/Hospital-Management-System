            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">View Approved</h5>
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $count=1;
                                            $sel_query="Select * from appointment, doctor, department WHERE patient_doctor = doctor_id  AND dept_id = patient_dept AND patient_status = 1";
