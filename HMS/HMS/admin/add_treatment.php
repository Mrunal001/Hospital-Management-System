                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="treatment_type" class="form-control" id="patient_name" onkeypress="return (event.charCode > 64 && 
    event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)"  >
                                            </div>
                                             <label for="blood_group" class="control-label col-form-label">Treatment Cost</label>
                                            <div class="col-sm-4">
                                                <input type="text" name="treatment_cost" class="form-control" id="blood_group" onkeypress="return isNumberKey(event)">
                                            </div>
                                        </div>
                                    <div class="form-group row">
